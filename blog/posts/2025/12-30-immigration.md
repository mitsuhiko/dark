---
tags: ["immigration"]
summary: "Legal immigration is a fugazi."
---

# Immigration

Legal immigration is a [fugazi](https://www.merriam-webster.com/slang/fugazi).
...
article 14 of the Universal Declaration of Human Rights from 1948:

> Everyone has the right to seek and to enjoy in other countries asylum from
> persecution.

Except, of course, popular opinion does not care about international law and
...
Every country has their own rules around immigration but rarely are those rules
...
understand them, and that includes the officials enforcing them.

There are children born to mixed citizenship couples who only found out years
...
thrown into a legal limbo when they first get a job.

If the powers in charge want to change the rules, they can.  [Japanese Americans
lost their
rights](https://en.wikipedia.org/wiki/Internment_of_Japanese_Americans) during
World War II.  German Jews lost their citizenship under the [Nuremberg
Laws](https://en.wikipedia.org/wiki/Nuremberg_Laws).  Even in the 2000s in the
UK the [Windrush generation](https://en.wikipedia.org/wiki/Windrush_scandal) of
immigrants discovered decades later that they were not able to demonstrate their
right to stay, despite having lived there for decades and fully legally.
...
The path to a green card for spouses in the US typically goes through a
...
citizens at their interviews and arrests them.

It's easy to picture immigration as being linked to the crossing of borders.
...
Europe has a history of deportations.  Jews were often seen as being in a
permanent state of "not integrated" and "not immigrated."  Jews were expelled
from Vienna [multiple times over the
centuries](https://en.wikipedia.org/wiki/History_of_the_Jews_in_Vienna).  Jews
gained and lost their rights repeatedly in the Hapsburg Empire.  Sometimes they
*just* lost their rights, other times their lives.
...
It wasn't just Jews though, it was also various European minorities in other
countries.  [There](https://en.wikipedia.org/wiki/Vienna_Gesera)
[was](https://en.wikipedia.org/wiki/Edict_of_Expulsion)
[no](https://en.wikipedia.org/wiki/Alhambra_Decree)
[shortage](https://en.wikipedia.org/wiki/Prussian_deportations)
[of](https://en.wikipedia.org/wiki/Polenaktion)
[ethnic](https://en.wikipedia.org/wiki/Population_exchange_between_Greece_and_Turkey)
[groups](https://en.wikipedia.org/wiki/Deportation_of_the_Crimean_Tatars)
[settling](https://en.wikipedia.org/wiki/Expulsion_of_Germans_from_Czechoslovakia)
[in](https://en.wikipedia.org/wiki/Flight_and_expulsion_of_Germans)
[other](https://en.wikipedia.org/wiki/June_deportation)
[countries](https://en.wikipedia.org/wiki/Deportation_of_the_Chechens_and_Ingush)
[only](https://en.wikipedia.org/wiki/Highland_Clearances)
[to](https://en.wikipedia.org/wiki/Great_Trek)
[be](https://en.wikipedia.org/wiki/Population_transfer_in_the_Soviet_Union)
[expelled](https://en.wikipedia.org/wiki/History_of_the_Jews_in_France)
[later](https://en.wikipedia.org/wiki/Expulsion_of_Jews_from_Spain).  Catholics
were also not great friends of own Christian neighbors in many places.  [20.000
protestants](https://en.wikipedia.org/wiki/Salzburg_Protestants) had to flee
from Salzburg in Austria all the way to Königsberg (modern Kaliningrad) in the
18th century.

So rather than talking about legal and illegal immigration, it would be much
...
that tastes are subject to change.

> “Here in our fatherland of Austria, conditions lie such that the Jews have
